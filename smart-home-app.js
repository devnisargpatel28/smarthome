...
function registerAgent(app) {
  ...
  app.post('/smarthome', function(request, response) {
    //console.log('nisarg smart-home-app post /smarthome request hedaders=>', request.headers);
    let reqdata = request.body;
    //console.log('<===request body/data', reqdata);
    //console.log('nisarg request=====>', request);
    console.log('nisarg request headers=====>', request.headers);
    let authToken = authProvider.getAccessToken(request);
    //console.log('nisarg authToken=====>', authToken);
    ...
    console.log('nisarg reqdata=====>', reqdata);
    console.log('nisarg reqdata.inputs=====>', reqdata.inputs);
