...
Auth.registerAuth = function(app) {
  ...
  console.log('nisarg oauth callllleeddddddddd ');    
    let clientId = req.query.client_id;
    let redirectUri = req.query.redirect_uri;
    let state = req.query.state;
    let responseType = req.query.response_type;
    let authCode = req.query.code;
    console.log('175 nisarg oauth callllleeddddddddd ' + responseType);
    if ('code' != responseType) {
      return res.status(500)
        .send('response_type ' + responseType + ' must equal "code"');
    }

    console.log('181 nisarg oauth callllleeddddddddd ' + clientId);
    ...
    console.log('193 nisarg oauth callllleeddddddddd ');
